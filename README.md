...
[![CI](https://github.com/YOUR_USERNAME/multi-agent-data-pipeline/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/multi-agent-data-pipeline/actions)
...
> Downstream: [ticket-triage-agent](https://github.com/YOUR_USERNAME/ticket-triage-agent)
...
(documented in the downstream [`ticket-triage-agent`](https://github.com/YOUR_USERNAME/ticket-triage-agent)
